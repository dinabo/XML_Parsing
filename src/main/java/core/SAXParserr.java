...
public class SAXParserr extends DefaultHandler {
	...
	public static void main(String[] args) throws IOException, SAXException,
		...
		final String element_01 = "normalized-kw";
		final String element_02 = "forms-action-type";
		final String element_03 = "form-display-ranking";
		final String element_04 = "response-time";
		final String element_05 = "merchants";

		final String element_name_01 = "Key Word: ";
		final String element_name_02 = "forms-action-type: ";
		final String element_name_03 = "form-display-ranking: ";
		final String element_name_04 = "Response time: ";
		final String element_name_05 = "Number of merchants: ";
